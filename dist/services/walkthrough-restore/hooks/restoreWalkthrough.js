...
exports.restoreWalkthrough = void 0;
 ...
 */
const restoreWalkthrough = async (context) => {
    ...
    const isSuperAdmin = (await (0, roles_1.getUserRoles)(adapters_1.drizzleAdapter, userId)).includes('superadmin');
    if (!isSuperAdmin) {
        // Check project membership (editor+ required to restore)
        const [membership] = await adapters_1.db
            .select()
            .from(schema_1.projectMembers)
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.projectMembers.projectId, wt.projectId), (0, drizzle_orm_1.eq)(schema_1.projectMembers.userId, userId)))
            .limit(1);
...
exports.restoreWalkthrough = restoreWalkthrough;
