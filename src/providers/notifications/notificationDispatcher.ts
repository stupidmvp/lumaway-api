...
import type { ProjectSettings } from '../../services/projects/projects.settings-schema';
...
export interface DispatchNotificationOptions {
    ...
    /** Project ID — if provided, project-level notification settings are checked first */
    projectId?: string;
    /** In-app notification title */
    title: string;
    /** In-app notification body (truncated preview) */
    body?: string;
    /** Arbitrary metadata stored with the notification */
    metadata?: Record<string, any>;
    /** Email payload — if omitted, no email is sent regardless of preferences */
    email?: {
        subject: string;
        html: string;
        text?: string;
 ...
 */
const PROJECT_SETTING_MAP: Record<string, keyof ProjectSettings> = {
 ...
 */
const PROJECT_SETTING_DEFAULTS: Record<string, boolean> = {
 ...
 */
export function buildCommentUrl(metadata: Record<string, any>): string {
